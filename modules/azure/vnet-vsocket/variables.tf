...
variable "azure_kms_ip" {
  type        = string
  description = "The IP address of the Azure Key Management Service (KMS) for the vSocket."
  default     = "23.102.135.246/32"
}

variable "lan_ip" {
  type        = string
  description = "The IP address to assign to the LAN interface of the vSocket."
  default     = null
}

variable "site_name" {
  type        = string
  description = "The name of the site where the vSocket will be deployed."
  default     = null
}
